...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark"  >
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" id="ss" href="#" >Connexion</a>
      </li>
    </ul>
  </div>
</nav>
  ...
  <div id="formContent">
    ...
    <form action="connexion_action.php" method="post">
      <input type="text" id="Adresse" class="fadeIn second" name="adresse" placeholder="Adresse" required="required">
      <input type="password" id="password" class="fadeIn third" name="password" placeholder="Mode de passe" required="required">
      <input type="submit" class="fadeIn fourth" value="Connexion">
    </form>

    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="#">inscription?</a>
    </div>
