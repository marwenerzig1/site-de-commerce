...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark"  >
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="http://localhost/5edmty/projet/ordinateur_de_bureau2.php?#">Ordinateur De Bureau</a>
      </li>
    </ul>
...
<?php
 ...
 $res_notes = $cnx->query("SELECT * from pc_portable"); 
...
echo "<tr><td>"."<img src='$item[4]'  width=200px height=200px>"."</td><td>" . $item[1]."</td><td>".$item[2]."</td><td>".$item[3]."DT"."</td><td><a href='supp1-sql.php?dd1=$item[0]'>
<input type='submit' value='Delete' class='btn btn-danger'></a></a><a href='modifier2.php?pp1=$item[0]'><input type='submit' value='Modification' class='btn btn-primary'></a></td></tr>";
}
echo "</table>";
}
?>
