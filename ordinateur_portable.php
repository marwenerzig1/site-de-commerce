...
echo "<tr><td>" . $item[0]."</td><td>" ."<img src='$item[4]'  width=200px height=200px>"."</td><td>" . $item[1]."</td><td>".$item[2]."</td><td>".$item[3]."</td><td>".
"<a href='acheter2.php?pp1=$item[0]'><input type='submit' value='Ajouter au Panier' class='btn btn-success'></a>"
."</td></tr>";
}
echo "</table>";
}
